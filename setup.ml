...
(* OASIS_START *)
(* DO NOT EDIT (digest: b434c57e955262353e6f426e999db62f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/essdotteedot/sessions";
          synopsis =
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Library to provide session types to allow for static verification of protocols between concurrent processes."
              ];
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Binary_session_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "sessions";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "sessions-lwt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "vending_machine.ml"});
               Doc
                 ({
                     cs_name = "sessions-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "API reference for sessions";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/essdotteedot/sessions.git";
                      src_repo_browser =
                        Some "https://github.com/essdotteedot/sessions";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some ")42\151\132j\020\151\019\223\025Z\016\234\012{";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
